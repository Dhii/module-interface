...
use Dhii\Modular\Module\Exception\ModuleException;
use Dhii\Modular\Module\Exception\ModuleSetupException as TestSubject;
 ...
 * @since [*next-version*]
 */
class ModuleSetupExceptionTest extends TestCase
{
    /**
     * @since [*next-version*]
     */
    public function testConstruct()
    {
        ...
        static::assertInstanceOf(ModuleException::class, $subject);
    }
